...
settings = {
  init = function(self)
    ...
    if SteaSummonSave.warlocksAssist == nil then
      ...
      SteaSummonSave.assistPlayers = {"Exampleplayer", "Anotherexample"}
      SteaSummonSave.raidLeaders = {"Leaderplayer", "Backupleader"}
      SteaSummonSave.masterLoot = {"Mlguy", "Mlbackup"}
      SteaSummonSave.autoInviteTriggers = {"inv", "invite"}
      SteaSummonSave.autoInvite = 4
      SteaSummonSave.autoAccept = 4

...
function optionsgui.init()
  ...
  LibStub("AceConfig-3.0"):RegisterOptionsTable("SteaSummonMessages", chat)
  LibStub("AceConfig-3.0"):RegisterOptionsTable("SteaSummonWords", summonwords)
  LibStub("AceConfig-3.0"):RegisterOptionsTable("SteaSummonPrios", priorities)
